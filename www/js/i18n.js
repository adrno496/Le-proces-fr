...
const STRINGS = {
  ...
  "onb.step.3.title":  { fr: "Tout est sur le tableau de bord", en: "Everything lives on the dashboard" },
  "onb.step.3.body":   { fr: "Le tribunal regroupe toutes vos activités : audiences quotidiennes, libres, sagas, codex juridique, mini-jeux. Voici les principaux modules :", en: "The tribunal screen groups all your activities: daily and free hearings, sagas, codex, mini-games. Here are the main modules:" },
  "onb.step.4.title":  { fr: "Progressez et collectionnez", en: "Progress and collect" },
  "onb.step.4.body":   { fr: "Verdicts → XP → carrière (6 grades). Débloquez progressivement 308 entrées de codex, 12 succès visibles + 30+ secrets, des objets de cabinet, et une réputation propre.", en: "Verdicts → XP → career (6 ranks). Unlock 308 codex entries, 12 visible achievements + 30+ secret ones, chamber items, and your own reputation." },
  "onb.step.5.title":  { fr: "Vos données restent chez vous", en: "Your data stays with you" },
  "onb.step.5.body":   { fr: "100 % local — rien n'est envoyé à un serveur. Une clé API IA (Groq, OpenAI, Anthropic, Mistral, OpenRouter) reste optionnelle : sans clé, le jeu fonctionne avec 300 affaires bilingues en cache. La voix, l'interface et le codex sont gratuits.", en: "100 % local — nothing is sent to a server. An AI API key (Groq, OpenAI, Anthropic, Mistral, OpenRouter) stays optional: without one, the game runs with 300 bilingual cached cases. Voice, UI and codex are free." },
  "onb.step.6.title":  { fr: "Choisissez votre niveau", en: "Pick your level" },
  "onb.step.6.body":   { fr: "Adapte les affaires à votre profil. Vous pouvez changer à tout moment dans les Réglages.", en: "Tunes cases to your profile. You can change this any time in Settings." },
  "onb.feat.daily.title": { fr: "Audience du jour", en: "Daily hearing" },
  "onb.feat.daily.body":  { fr: "Une affaire unique par jour, +XP × 1,5, séries (streak) et défis hebdomadaires.", en: "One unique case per day, +1.5× XP, streaks and weekly challenges." },
  "onb.feat.free.title":  { fr: "Audience libre", en: "Free hearing" },
  "onb.feat.free.body":   { fr: "Choisissez la catégorie ou laissez le hasard. 18 thèmes : pénal, civil, ubuesque, animaux…", en: "Pick a category or trust randomness. 18 themes: criminal, civil, absurd, animals…" },
  "onb.feat.saga.title":  { fr: "Sagas multi-actes", en: "Multi-act sagas" },
  "onb.feat.saga.body":   { fr: "11 personnages, 5 actes chacun. Vos verdicts façonnent leur trajectoire.", en: "11 characters, 5 acts each. Your verdicts shape their path." },
  "onb.feat.hist.title":  { fr: "Procès historiques", en: "Historic trials" },
  "onb.feat.hist.body":   { fr: "100 grandes affaires (Calas, Dreyfus, Nuremberg, AI Act…) à rejouer.", en: "100 great trials (Calas, Dreyfus, Nuremberg, AI Act…) to replay." },
  "onb.feat.codex.title": { fr: "Codex & glossaire", en: "Codex & glossary" },
  "onb.feat.codex.body":  { fr: "308 articles + notions. Cliquez sur un terme pour la définition, lien Légifrance.", en: "308 articles + notions. Tap a term for the definition, Légifrance link." },
  "onb.feat.guess.title": { fr: "Devine la peine", en: "Guess the sentence" },
  "onb.feat.guess.body":  { fr: "104 cas réels — quelle sanction prononcerait un vrai juge ? Mini-jeu rapide.", en: "104 real cases — what would a real judge order? Quick mini-game." },
